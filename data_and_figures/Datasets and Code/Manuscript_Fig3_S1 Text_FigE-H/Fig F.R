...
data_set <- readRDS(paste0(getwd(),"/data_Fig3a.rds"))
...
##################
data_set <- readRDS(paste0(getwd(),"/data_Fig3b.rds"))
...
ggsave(filename = paste0(getwd(),"/","Fig F.pdf"),
       plot = ab,
       width = 18,
       height = 10,
       dpi = 300)
